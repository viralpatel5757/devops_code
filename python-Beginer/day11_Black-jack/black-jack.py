...
play = input("do you want to play black-jack game ? please typ 'yes' or 'no': ")
print(logo)
cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
...
def play_game():
    ...
    while not end_game:
        ...
        print(f"your current score is {final_user_score}")
        
        if final_user_score == 0 or final_user_score > 21 or final_computer_score == 0 :
            end_game = True
        else:
            go_on = input("do you want to draw another card? 'yes' or 'no': ")  
            if go_on == "yes" :
                user_cards.append(deal_card())
                end_game = False 
            else:
    ...
    while final_computer_score < 17 and final_computer_score != 0:
        computer_cards.append(deal_card())
        final_computer_score = calculate_score(computer_cards)
        print (computer_cards)
    ...
    def compare(final_user_score, final_computer_score):
        if final_user_score == final_computer_score:
            result = print("it is draw")
            return result
        elif  final_computer_score == 0:
            result = print("You Lose you Loserrr !!!!!")
            return result  
    ...
    compare(final_user_score, final_computer_score)                    
